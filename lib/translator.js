...
exports.speak = function (options, fn) {
    Request({
        url : 'http://speak.get-translator.com/speak/?lang='+options.lang+'&q='+encodeURI(options.text.substr(0, 400)),
        onComplete : fn
    }).get();
};
